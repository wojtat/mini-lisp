...
fn builtInLambda(self: *Self, list: LinkedListWrapper) !Expression {
...
fn builtInDefine(self: *Self, list: LinkedListWrapper) !Expression {
...
fn builtInQuote(self: *Self, list: LinkedListWrapper) !Expression {
    var iter = list.iterator();
    iter.advance(1);
    if (!iter.hasLen(1)) {
        return error.WrongNumberOfArguments;
...
fn builtInIf(self: *Self, list: LinkedListWrapper) !Expression {
    var iter = list.iterator();
    iter.advance(1);
    if (!iter.hasLen(3)) {
        return error.WrongNumberOfArguments;
...
fn builtInCar(self: *Self, list: LinkedListWrapper) !Expression {
    var iter = list.iterator();
    iter.advance(1);
    if (!iter.hasLen(1)) {
        return error.WrongNumberOfArguments;
...
fn builtInCdr(self: *Self, list: LinkedListWrapper) !Expression {
    var iter = list.iterator();
    iter.advance(1);
    if (!iter.hasLen(1)) {
        return error.WrongNumberOfArguments;
...
fn builtInSub(self: *Self, list: LinkedListWrapper) !Expression {
    var iter = list.iterator();
    iter.advance(1);
...
fn builtInMul(self: *Self, list: LinkedListWrapper) !Expression {
    var iter = list.iterator();
    iter.advance(1);
    var int_prod: i64 = 1;
    while (iter.peek()) |next| : (_ = iter.next()) {
...
fn call(self: *Self, list: LinkedListWrapper) !Expression {
    var iter = list.iterator();
